...
public class IOTools
{
    ...
    public static string FileUplader(string MyPath,string FileId, HttpPostedFileBase MyFile, string[] FileEx)
    {
        string Msg = "";
        ...
        if (FileEx.Contains(MyFileEx))
        {
            ...
            MyFile.SaveAs(HttpContext.Current.Server.MapPath(MyPath) + "/" + FileId.ToString() + "-" + MyFileName);
